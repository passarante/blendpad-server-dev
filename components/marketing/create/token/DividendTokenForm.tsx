...
const DividendTokenForm = ({
  handleTokenTypeChange,
}: DividendTokenFormProps) => {
        ...
        <Card>
          <CardContent className="p-4">
            <div className="grid grid-cols-3 gap-10">
              ...
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Marketing Fee Token</Label>
                <Select
                  value={marketingFeeToken}
                  onValueChange={(mFeeToken) =>
                    setMarketingFeeToken(
                      mFeeToken as "itself" | "base" | "reward"
                    )
                  }
                >
                  <SelectTrigger className="w-[180px] h-12">
                    {marketingFeeToken == "itself" && (
                      <div className="flex items-center space-x-2">
                        <span>Token Itself</span>
                      </div>
                    )}
                    {marketingFeeToken == "base" && (
                      <div className="flex items-center space-x-2">
                        <span>Base Token</span>
                      </div>
                    )}
                    {marketingFeeToken == "reward" && (
                      <div className="flex items-center space-x-2">
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="itself" className="flex w-full">
                        Token Itself
                      </SelectItem>
                      <SelectItem value="base" className="flex w-full">
                        Base Token
                      </SelectItem>
                      <SelectItem value="reward" className="flex w-full">
                        Reward Token
                      </SelectItem>
                    </SelectGroup>
                  </SelectContent>
              ...
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Min token balance for rewards</Label>
                <Input className="h-12" />
              </div>
...
export default DividendTokenForm;

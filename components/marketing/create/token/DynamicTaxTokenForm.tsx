...
const DynamicTaxTokenForm = ({
  handleTokenTypeChange,
}: DynamicTaxTokenFormProps) => {
  ...
  const [marketingFeeToken, setMarketingFeeToken] = useState<
    "itself" | "base" | "reward"
  >("itself");
        ...
        <Card>
          <CardContent className="p-4">
            <div className="grid grid-cols-3 gap-10">
              ...
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Tax Decrease Every (x seconds)</Label>
                <Input className="h-12" />
              </div>

              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Tax Decrease by (%)</Label>
                <Input className="h-12" />
              </div>

              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Sell Liquidity Fee Min Limit (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Buy Liquidity Fee Min Limit (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Sell Marketing Fee Min Limit (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Buy Marketing Fee Min Limit (%)</Label>
                <Input className="h-12" />
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <ul className="text-gray-400 ">
              ...
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Decrement Interval</span>
                <span>%</span>
              </li>
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Fee Decrements</span>
                <span>%</span>
              </li>

              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Min Sell Liquidity Fee Limit</span>
                <span>%</span>
              </li>

              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Min Buy Marketing Fee Limit</span>
                <span>%</span>
              </li>

              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Min Sell Marketing Fee Limit</span>
                <span>%</span>
              </li>

              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Min Buy Liquidity Fee Limit</span>
                <span>%</span>
              </li>
            </ul>
...
export default DynamicTaxTokenForm;

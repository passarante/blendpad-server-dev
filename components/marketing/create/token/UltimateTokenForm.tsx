...
const UltimateTokenForm = ({
  handleTokenTypeChange,
}: UltimateTokenFormProps) => {
        ...
        <Card>
          <CardContent className="p-4">
            <div className="grid grid-cols-3 gap-10">
              ...
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Sell Reward Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Buy Reward Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Sell Treasury Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Buy Treasury Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Sell Burn Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex flex-col justify-center space-y-4 ">
                <Label>Buy Burn Fee (%)</Label>
                <Input className="h-12" />
              </div>
              <div className="flex items-center justify-center  ">
                <div className="flex items-center space-x-2">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <ul className="text-gray-400 ">
              ...
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Sell Treasury Fee</span>
                <span>%</span>
              </li>
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Buy Treasury Fee</span>
                <span>%</span>
              </li>
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Sell Burn Fee</span>
                <span>%</span>
              </li>
              <li className="flex w-full items-center justify-between border-b-2 border-b-gray-900 py-1">
                <span>Buy Burn Fee</span>
                <span>%</span>
              </li>
            </ul>
...
export default UltimateTokenForm;
